...
module.exports = {
    ...
    let helpmenu = new MessageEmbed()
        .setAuthor(`Syno Music Help Panel`, ee.footericon)
        .setDescription(`
...
**${emoji.categories.AnimatedDiscord} Help related to Syno Music's commands** [Bot Website](https://Synobot.ml/)
 ...
 `)
        ...
        .addComponents(
            new MessageSelectMenu()
                .setCustomId('helpop')
                .setPlaceholder('❯ Syno Music Help Menu!')
                .addOptions([
                {
                ...
                {
                    label: 'Info Commands',
                    description: 'To get some information of Syno Music Music',
                    value: 'third',
                ...
                {
                    label: 'Settings',
                    description: 'Syno Music Settings',
                    value: 'fifth',
