...
const { Intents, WebhookClient, MessageEmbed,
MessageActionRow, MessageButton, Collection} = require("discord.js");
...
client.on('guildCreate', async (guild) => {
    ...
    client.channels.cache.get("891637902361100359").send({embeds: [embed]})
  ...
  try {
    ...
    const texts = "Hi, This Is GRAVEL If You Need Support Related Me Join My Support Server. Support Server Link Is Here https://discord.gg/MrXGSMGfGk"
